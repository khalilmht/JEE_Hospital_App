...
ApplicationContext context=SpringApplication.run(HopitalApplication.class,args);
		...
		Utilisateur u4=new StandardUser("mht","khalil","khalilmht@gmail.com","moi1234","N'djari");
		Utilisateur u5=new StandardUser("mht","khalil","khalilmht@gmail.com","moi1234","N'djari");
		Utilisateur u6=new StandardUser("mht","khalil","khalilmht@gmail.com","moi1234","N'djari");
		Utilisateur u7=new StandardUser("mht","khalil","khalilmht@gmail.com","moi1234","N'djari");

		utilisateurDao.save(u1);
		utilisateurDao.save(u2);
		utilisateurDao.save(u3);
		utilisateurDao.save(u4);
		utilisateurDao.save(u5);
		utilisateurDao.save(u6);
		utilisateurDao.save(u7);
